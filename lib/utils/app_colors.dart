...
class AppColors {
  ...
  // Industrial Theme Specific Colors
  static const Color industrialOrange = Color(0xFFEA580C); // Safety Orange
  static const Color industrialYellow = Color(0xFFEAB308); // Warning Yellow
  static const Color industrialRed = Color(0xFFDC2626); // Danger Red
}
